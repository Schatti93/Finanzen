...
"}")
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(900, 460, 311, 108))
        ...
        self.gesamt_gewinn = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.gesamt_gewinn.setObjectName("gesamt_gewinn")
        self.verticalLayout.addWidget(self.gesamt_gewinn)
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(self.tab)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(380, 460, 311, 108))
        ...
        self.gesamt_ausgaben = QtWidgets.QLabel(self.verticalLayoutWidget_2)
